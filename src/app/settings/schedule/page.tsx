  ...
  return (
    <div className="relative min-h-screen max-w-md mx-auto bg-background-light dark:bg-background-dark pb-[88px]">
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between p-4 pb-2 border-b border-slate-200 dark:border-border-dark/30 bg-background-light dark:bg-background-dark">
        <button className="flex size-12 items-center justify-start active:opacity-70">
          <span className="material-symbols-outlined text-[24px]">
            arrow_back_ios_new
          </span>
        </button>

        <h2 className="flex-1 text-center text-lg font-bold tracking-[-0.015em] pr-12">
          의사 스케줄 등록
        </h2>

        <div className="absolute right-4">
          <button className="text-primary font-bold active:opacity-70">
            저장
          </button>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-4 px-4 py-6">
          ...
          <label className="flex flex-col gap-2">
            ...
            <div className="relative">
              <select className="h-14 w-full rounded-xl border border-slate-300 dark:border-border-dark bg-white dark:bg-surface-dark px-4 pr-10 text-base appearance-none">
                <option>응급의학과</option>
                <option>외과</option>
                <option>내과</option>
                <option>정형외과</option>
